    ...
    MediumEditor.prototype = {
        ...
        serialize: function () {
            ...
            for (i = 0; i < this.elements.length; i += 1) {
                ...
                content[elementid] = this.elements[i].innerHTML.trim();
            }
            return content;
        },
        ...
        buttonTemplate: function(btnType) {
            var buttonTemplates = {
                ...
                'quote': '<li><button class="medium-editor-action medium-editor-action-quote" data-action="append-blockquote" data-element="blockquote"><span class="icon-quote"></span></button></li>',
