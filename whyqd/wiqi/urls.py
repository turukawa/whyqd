...
urlpatterns = patterns("whyqd.wiqi.views",
                       ...
                       # edit_wiqi: create, edit, fork
                       url(r"^create/(?P<wiqi_type>[-\w]+)/(?P<linked_wiqi_surl>[-\w]+)/", "edit_wiqi", {"template_name": "wiqi/view.html", "nav_type":"create", "permission":None}, name="create_linked_wiqi"),
                       url(r"^create/(?P<wiqi_type>[-\w]+)/", "edit_wiqi", {"template_name": "wiqi/view.html", "nav_type":"create", "permission":None}, name="create_wiqi"),                       
                       url(r"^create/", "edit_wiqi", {"template_name": "wiqi/view.html", "nav_type":"create", "permission":None}, name="create_default_wiqi"),
                       url(r"^edit/(?P<wiqi_type>[-\w]+)/(?P<wiqi_surl>[-\w]+)/(?P<linked_wiqi_surl>[-\w]+)/", "edit_wiqi", {"template_name": "wiqi/view.html", "nav_type":"edit", "permission":"can_edit"}, name="edit_wiqi"),
                       url(r"^edit/(?P<wiqi_type>[-\w]+)/(?P<wiqi_surl>[-\w]+)/", "edit_wiqi", {"template_name": "wiqi/view.html", "nav_type":"edit", "permission":"can_edit"}, name="edit_wiqi"),
                       url(r"^fork/(?P<wiqi_type>[-\w]+)/(?P<wiqi_surl>[-\w]+)/", "edit_wiqi", {"template_name": "wiqi/view.html", "nav_type":"fork", "permission":"can_fork"}, name="fork_wiqi"),
