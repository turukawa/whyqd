...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Token.redeemed_on'
        db.alter_column(u'novel_token', 'redeemed_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Token.redeemed_on'
        db.alter_column(u'novel_token', 'redeemed_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 7, 0, 0)))
