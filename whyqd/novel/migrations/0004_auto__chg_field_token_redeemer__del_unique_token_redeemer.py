...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Token', fields ['redeemer']
        db.delete_unique(u'novel_token', ['redeemer_id'])


        # Changing field 'Token.redeemer'
        db.alter_column(u'novel_token', 'redeemer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['usr.User']))

    def backwards(self, orm):

        # Changing field 'Token.redeemer'
        db.alter_column(u'novel_token', 'redeemer_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['usr.User']))
        # Adding unique constraint on 'Token', fields ['redeemer']
        db.create_unique(u'novel_token', ['redeemer_id'])
    ...
    models = {
        ...
        'novel.token': {
            ...
            'novel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['novel.Novel']", 'null': 'True', 'blank': 'True'}),
            'recipient': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'redeemed_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'redeemer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'token_redeemer'", 'null': 'True', 'to': u"orm['usr.User']"}),
        ...
        u'usr.user': {
            ...
            'current_price': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '10', 'decimal_places': '2'}),
