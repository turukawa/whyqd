...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Token', fields ['novel']
        db.delete_unique(u'novel_token', ['novel_id'])


        # Changing field 'Token.novel'
        db.alter_column(u'novel_token', 'novel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['novel.Novel'], null=True))

    def backwards(self, orm):

        # Changing field 'Token.novel'
        db.alter_column(u'novel_token', 'novel_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['novel.Novel'], unique=True, null=True))
        # Adding unique constraint on 'Token', fields ['novel']
        db.create_unique(u'novel_token', ['novel_id'])
